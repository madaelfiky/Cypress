...
describe("Hr Add Employee",()=> {
  ...
  it("Hr Add Employee",()=> {
    ...
    for (let n = 1; n <= 5; n++) {
      ...
      cy.visit("https://web-huic.haj.gov.sa/newumrah-test/bsp/ExternalAgencies/Groups/CreateGroup/CfDJ8KfNMWrNXERPuyqjjVXyx6fjqq_LkG-YrLFZvB-4hgtlzQDwrVtzZ3sGvzuRyDyO91zmaFTNsJiex1CGey19MeG0wT4acV3o1J5vZJMTHDEvQtO3i9NlC9cI1FbHm6kasg");
      //cy.wait(5000);
